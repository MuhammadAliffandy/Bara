...
struct OnboardingDynamicIslandView: View {
    ...
    var body: some View {
        ...
        VStack(alignment:.center){
            ...
            VStack(
                ...
                AppHeadline(
                    title: "If you stay away too long…",
                ...
                AppButton(
                    action: {
                        router.push(.onboardingScreenTime)
                    },
                        textButton: "Next",
                        textColor: .white,
        ...
        .background(
            Image(AppImage.ImageOnboardDynamic)
